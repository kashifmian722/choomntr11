...
Shopware.Service('cmsService').registerCmsBlock({
    name: 'image-text-bubble-six',
    label: 'custom.sw-cms.blocks.textImage.imageTextBubbleSix.label',
    category: 'text-image',
    component: 'sw-cms-block-image-text-bubble-six',
    previewComponent: 'sw-cms-preview-image-text-bubble-six',
    defaultConfig: {
        marginBottom: '20px',
        marginTop: '20px',
        marginLeft: '20px',
