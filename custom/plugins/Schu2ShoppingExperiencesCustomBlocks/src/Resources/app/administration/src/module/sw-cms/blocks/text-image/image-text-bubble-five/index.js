...
Shopware.Service('cmsService').registerCmsBlock({
    name: 'image-text-bubble-five',
    label: 'custom.sw-cms.blocks.textImage.imageTextBubbleFive.label',
    category: 'text-image',
    component: 'sw-cms-block-image-text-bubble-five',
    previewComponent: 'sw-cms-preview-image-text-bubble-five',
    defaultConfig: {
        marginBottom: '20px',
        marginTop: '20px',
        marginLeft: '20px',
